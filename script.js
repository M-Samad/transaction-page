...
logo.setAttribute('company', 'asfinance');

console.log(logo.src); // absolute attribute
console.log(logo.getAttribute('src')); // rrlative attribute
...
//   alert('onmouseenter: ffsfsfsfsfsfsfsadfsafsafsafasfsf :D');
// };
...
//   console.log('fsfsdsgdgdsfgdsgsdgfvg', e);
// });
